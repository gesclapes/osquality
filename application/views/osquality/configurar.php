                        ...
                        <div class="form-actions">
                            <div class="span8">
                                <div class="span9">
                                    ...
                                    <button href="#modal-confirmaratualiza" data-toggle="modal" type="button" class="btn btn-danger"><i class="fas fa-sync-alt"></i> Atualizar osquality</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div id="modal-confirmaratualiza" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        ...
        <div class="modal-footer">
            ...
            <button id="update-osquality" type="button" class="btn btn-danger"><i class="fas fa-sync-alt"></i>Atualizar</button>
        </div>
    </form>
</div>
<!-- Modal -->
    ...
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        ...
        <div class="modal-body">
            ...
            <h7 style="text-align: left">Recomendamos que faça um backup antes de prosseguir!
                <a target="_blank" title="Fazer Bakup" class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/osquality/backup">Fazer Backup</a>
            </h7>
        </div>
        <div class="modal-footer">
            <button class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</button>
...
<script>
    $('#update-database').click(function () {
        window.location = "<?= site_url('osquality/atualizarBanco') ?>"
    });
    $('#update-osquality').click(function() {
        window.location = "<?= site_url('osquality/atualizarosquality') ?>"
    });
