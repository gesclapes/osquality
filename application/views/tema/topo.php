...
<head>
  <title><?= $configuration['app_name'] ?: 'OS Quality' ?></title>
  <meta charset="UTF-8" />
...
<body>
  <!--Header-part-->
  <div id="header">
    <h1><a href=""> <?= $configuration['app_name'] ?: 'OS Quality' ?> </a></h1>
  </div>
  <!--close-Header-part-->
  <!--top-Header-menu-->
    ...
    <ul class="nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li class=""><a title="Meu Perfil" href="<?= site_url('osquality/minhaConta'); ?>"><i class="fas fa-user"></i> <span class="text">Meu Perfil</span></a></li>
          <li class="divider"></li>
  ...
  <!--start-top-serch-->
  <div id="search">
    <form action="<?= site_url('osquality/pesquisar') ?>">
