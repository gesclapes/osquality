                            ...
                            <?php if ($emitente == null) { ?>
                                ...
                                <tr>
                                    <td colspan="3" class="alert">Você precisa configurar os dados do emitente. >>><a
                                                href="<?php echo base_url(); ?>index.php/osquality/emitente">Configurar</a>
                                        <<<
                                    </td>
                                </tr> <?php } else { ?>
                                <tr>
...
<div class="span6" style="padding: 1%; margin-left: 0">
    ...
    <a target="_blank" title="Imprimir OS" class="btn btn-danger"
                       href="<?php echo site_url() ?>/os/imprimir/<?php echo $result->idOs; ?>">
                       <span class="button__icon"><i class="bx bx-printer"></i></span> <span class="button__text">Imrpimir</span></a>
    </div>
</div>
