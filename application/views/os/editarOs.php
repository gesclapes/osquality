                        ...
                        echo 'selected';
                                    ...
                                    <div class="span6" style="padding: 1%; margin-left: 0">
                                        <div class="span6 offset3" style="text-align: center">
                                            <button class="btn btn-success" id="btnContinuar">Salvar</button>
                                    ...
                                    <div class="span6" style="padding: 1%; margin-rigth: 0">
                                        <div class="span6 offset3" style="text-align: center">
                                            <a title="Visualizar OS" class="btn btn-info"  role="button" href="<?php echo site_url() ?>/os/visualizar/<?php echo $result->idOs; ?>"><i class="fas fa-eye"></i> Visualizar OS</a>                                            
                        ...
                        <div class="tab-pane" id="tab2">
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <form id="formProdutos" action="<?php echo base_url() ?>index.php/os/adicionarProduto" method="post">
                                    ...
                                    <div class="span2">
                                        <label for="">&nbsp;</label>
                                        <button class="btn btn-success span12" id="btnAdicionarProduto"> Adicionar
                                        </button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="tab-pane" id="tab3">
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <form id="formServicos" action="<?php echo base_url() ?>index.php/os/adicionarServico" method="post">
                                    ...
                                    <div class="span2">
                                        <label for="">&nbsp;</label>
                                        <button class="btn btn-success span12"> Adicionar</button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="tab-pane" id="tab5">
                            <div class="span12" style="padding: 1%; margin-left: 0">
                                ...
                                <div class="span12" id="divAnotacoes" style="margin-left: 0">
                                    ...
                                    <a href="#modal-anotacao" id="btn-anotacao" role="button" data-toggle="modal" class="btn btn-success"> Adicionar anotação</a>
                                    <hr>
