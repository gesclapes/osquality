...
class Github_updater
{
    ...
    public function update()
    {
        ...
        if ($hash !== $this->ci->config->item('current_commit')) {
            ...
            if ($dir = $this->_get_and_extract($hash)) {
                ...
                // Update the osquality version in the config filename
    ...
    */
    ...
    /**
    * Get osquality current version.
    *
    * @return string osquality current version.
    */
    private function getCurrentVersion()
    {
        ...
        if (!$version) {
            throw new Exception('Error getting osquality version from GitHub!');
        }
